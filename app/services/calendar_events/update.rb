module CalendarEvents
  class Update
    ...
    def call(form_payload:, user_id:, id:)
      ...
      updated = @repository.update!(id: id, user_id: user_id, payload: payload)
      raise_from_response!(updated, fallback: "Etkinlik guncellenemedi.")

      row = extract_row(updated)
